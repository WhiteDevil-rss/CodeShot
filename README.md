...
2. **Right-click** and select `Capture CodeShot` OR press `Cmd+Shift+P` and type `CodeShot: Capture Selection`.
3. Customize your padding and background in the preview panel beside your code.
4. Click **Capture** to save your high-resolution image!
